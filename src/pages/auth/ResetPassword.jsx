...
function ResetPassword({match}) {
    ...
    //shows the error when users try to change password without gmail
    const [errorMessage, setErrorMessage] = useState(false);
    const [error, showError] = useState(false);

    return (
        <Container fluid className="min-vh-100 max-vh-100 px-5 clr-primary-400 ">
            <div class="container d-flex flex-column justify-content-around pt-lg-5 min100vh">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 AuthCard m-auto p-0 d-flex flex-column flex-md-row ">
                        <ResetPasswordForm  userID={userID} token={token} setErrorMessage={setErrorMessage} showError={showError} />
                    </div>
                    <div class="col-md-6">
                        <Banner />
                    </div>
