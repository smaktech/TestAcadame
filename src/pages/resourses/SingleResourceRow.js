...
function SingleResourceRow({row,index,openDeleteAlertModal,changeResourseStatus}) {
                ...
                <>
                    {row.status == 'inactive' ? (
                        <Button  
                            ...
                            onClick={() => changeResourseStatus(row,index, 'active')}
                            variant="text"
                            color="secondary"       
                        >
                            <ToggleOffIcon/>
                        ...
                        <Button variant="text"
                            onClick={() => changeResourseStatus(row,index, 'inactive')}
                    ...
                    &emsp;
                      <Button variant="text"
                        onClick={() => navigate('/dashboard/resources/editResource/' + row._id + '/' + row.status + '/' + row.name)}>
                        <EditIcon/>
                    </Button>
                    &emsp;
